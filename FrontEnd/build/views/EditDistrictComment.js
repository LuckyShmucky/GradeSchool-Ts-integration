...
const _jsxFileName = "C:/Users/xian/AT-Assignments/GradeSchool-Ts-integration/FrontEnd/src/views/EditDistrictComment.tsx";
...
function EditDistrictCommentForm(id) {
    ...
    const handleClick = (e) => __awaiter(this, void 0, void 0, function* () {
        e.preventDefault();
        const response = yield fetch(`https://back-end-for-grade-school.herokuapp.com/districts/updateComments/${id}`, {
            method: 'PUT',
            mode: 'cors',
            headers: {
