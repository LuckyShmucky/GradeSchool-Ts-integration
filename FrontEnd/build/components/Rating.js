...
const _jsxFileName = "C:/Users/xian/AT-Assignments/GradeSchool-Ts-integration/FrontEnd/src/components/Rating.tsx";
...
const Stars = (props) => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        const getSchools = () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const schoolPopulated = yield response.json();
            console.log(props);
    ...
    return ((0, jsx_dev_runtime_1.jsxDEV)("div", { children: rating }, void 0, false, { fileName: _jsxFileName, lineNumber: 66, columnNumber: 11 }, this));
};
