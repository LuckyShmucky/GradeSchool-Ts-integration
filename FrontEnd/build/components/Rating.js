...
var Stars = function (props) {
    ...
    var _a = (0, react_1.useState)([]), starArr = _a[0], setStarArr = _a[1];
    var initialStarArr;
    var _b = (0, react_1.useState)('Not yet Rated'), rating = _b[0], setRating = _b[1];
    // this runs on mount
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (starArr.length >= 1) {
            ...
            var averageRating = sum / starArr.length;
    ...
    return (react_1.default.createElement("div", null, rating));
};
