...
const Edit = () => {
  const { districtId } = useParams()
    ...
    const editDistrict = async (): Promise<any> => {
...
<div className='edit-page'>
            ...
            <form className="edit-form">
                ...
                <div className="row edit-content" style={{marginBottom: '25px'}}>
                  ...
                  <input type='number' min='50' max='10000' required className="form-control" name='salary' id='salary' onChange={(e) => setSalary(parseFloat(e.target.value))} />
                </div>
